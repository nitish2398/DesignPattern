...
import patterns.behavioural.strategy.impl.*;
 ...
 *
 * Strategy pattern segregates the normal inheritance (is a relation) to a patterns.behavioural.strategy interface having has a relationship
 * with actual context
 *
